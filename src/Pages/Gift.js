...
const giftItems = [
  { id: 1, name: "Gift Silver Ring", price: "₹2,000", metal: "Silver", image: "" },
  { id: 2, name: "Gift Gold Earrings", price: "₹3,500", metal: "Gold", image: "" },
  { id: 3, name: "Gift Bracelet", price: "₹1,800", metal: "Rose Gold", image: "" },
  { id: 4, name: "Gift Necklace", price: "₹4,200", metal: "Silver", image: "" },
];
  ...
  return (
    <div className="bg-white font-sans">
      ...
      <div className="w-full h-48 sm:h-72 md:h-96 lg:h-[450px] relative overflow-hidden rounded-b-3xl flex items-center justify-center bg-gray-100">
        <span className="text-gray-400 text-sm sm:text-base">Gift Collection Banner Placeholder</span>
      </div>
