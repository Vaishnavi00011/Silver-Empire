...
import Earing from "../assets/Images/1.png";
import Rings from "../assets/Images/2.png";
import Bracelets from "../assets/Images/3.png";
import Pendants from "../assets/Images/4.png";
...
const JewelleryShowcase = () => {
  ...
  const categories = [
    { name: "EARRINGS", imageUrl: Earing },
    { name: "RINGS", imageUrl: Rings },
    { name: "BRACELETS", imageUrl: Bracelets },
    { name: "PENDANTS", imageUrl: Pendants },
  ];
  ...
  return (
    <div
      ref={containerRef}
      className="flex justify-center items-center min-h-screen px-2 w-full overflow-x-hidden"
    >
      ...
      <div className="hidden md:grid max-w-7xl w-full mx-auto grid-cols-[85%_15%] items-stretch">
        ...
        <div
          ...
          style={{
            ...
            height: "370px",
            backgroundImage:
              'linear-gradient(135deg, rgba(255,105,180,0.7), rgba(75,0,130,0.7)), url("/Rectangle 1112.png")',
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <div
            className={`absolute inset-0 bg-gradient-to-tr from-white/20 via-white/10 to-white/20 opacity-0 group-hover:opacity-40 transition-opacity duration-500 rounded-2xl ${
              isVisible ? "animate-glow" : ""
            }`}
          ></div>
          <p
            className={`text-6xl font-extrabold mb-2 z-10 ${
          ...
          <div className="absolute top-2 left-1 w-4 h-4 bg-pink-400 rounded-full opacity-50 animate-pulse-slow"></div>
          <div className="absolute bottom-4 right-2 w-6 h-6 bg-indigo-400 rounded-full opacity-50 animate-pulse-slow"></div>
        </div>
      </div>

      {/* ================= MOBILE / TABLET ================= */}
      <div className="flex flex-col md:hidden justify-center items-center space-y-6 px-4 py-6 w-full">
        {/* Title */}
        <div
        ...
        <button className="relative w-44 py-2.5 px-6 rounded-full bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white font-semibold text-sm tracking-wide overflow-hidden shadow-lg hover:scale-105 transform transition-all group cursor-pointer flex justify-center items-center">
          {/* Moving shine */}
